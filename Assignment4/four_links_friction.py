...
def SimWorld():
    ...
    b = np.array([z, -10.0, z, z, z, -k_d*w1,   z, -10.0, z, z, z, -k_d*w2,   z, -10.0, z, z, z, -k_d*w3,   z, -10.0, z, z, z, -k_d*w4,   w1*w1*r1x, w1*w1*r1y, z,   -w1*w1*r1x-(w2*w2*r2x), -w1*w1*r1y-(w2*w2*r2y), z,   -w2*w2*r2x-(w3*w3*r3x), -w2*w2*r2y-(w3*w3*r3y), z,   -w3*w3*r3x-(w4*w4*r4x), -w3*w3*r3y-(w4*w4*r4y), z])
