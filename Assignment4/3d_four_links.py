...
class Link:
    ...
    thetaz=0          ## Rotate about z in object coordinate frame
    thetax=0          ## Rotate about x in object coordinate frame
    ...
    def draw(self):      ### steps to draw a link
        ...
        glRotatef(self.thetaz*RAD_TO_DEG,  0,0,1)                             ## rotate
        glRotatef(self.thetax*RAD_TO_DEG,  1,0,0)
...
def resetSim():
    ...
    link1.thetaz = init_angle1
    link1.thetax = init_angle1
...
def SimWorld():
    ...
    r1 = rotate_twice(np.array([0.0, 0.5, 0.0]), link1.thetaz, link1.thetax)
    r1x = r1[0]
    r1y = r1[1]
    r1z = r1[2]

    r2 = rotate_twice(np.array([0.0, 0.5, 0.0]), link2.thetaz, link2.thetax)
    r2x = r2[0]
    r2y = r2[1]
    r2z = r2[2]

    r3 = rotate_twice(np.array([0.0, 0.5, 0.0]), link3.thetaz, link3.thetax)
    r3x = r3[0]
    r3y = r3[1]
    r3z = r3[2]

    r4 = rotate_twice(np.array([0.0, 0.5, 0.0]), link4.thetaz, link4.thetax)
    r4x = r4[0]
    r4y = r4[1]
    r4z = r4[2]
    ...
    w1w1r1 = np.cross(w1, np.cross(w1, r1))
    w2w2r2 = np.cross(w2, np.cross(w2, r2))
    w3w3r3 = np.cross(w3, np.cross(w3, r3))
    w4w4r4 = np.cross(w4, np.cross(w4, r4))
    ...
    a = np.array([[m, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z,    k,     z,   z,    k,       z,      z,      z,      z,      z,     z,      z,      z],
                  ...
                  [z, z, z, I, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z,    z,     r1z, -r1y, z,       -r1z,   r1y,    z,      z,      z,     z,      z,      z],
                  [z, z, z, z, I, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z,    -r1z,  z,   r1x,  r1z,     z,      -r1x,   z,      z,      z,     z,      z,      z],
                  ...
                  [z, z, z, z, z, z, z, z, z, I, z, z, z, z, z, z, z, z, z, z, z, z, z, z,    z,     z,   z,    z,       -r2z,   r2y,    z,      -r2z,   r2y,   z,      z,      z],
                  [z, z, z, z, z, z, z, z, z, z, I, z, z, z, z, z, z, z, z, z, z, z, z, z,    z,     z,   z,    r2z,     z,      -r2x,   r2z,    z,      -r2x,  z,      z,      z],
                  ...
                  [z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, I, z, z, z, z, z, z, z, z,    z,     z,   z,    z,       z,      z,      z,      -r3z,   r3y,   z,      -r3z,   r3y],
                  [z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, I, z, z, z, z, z, z, z,    z,     z,   z,    z,       z,      z,      r3z,    z,      -r3x,  r3z,    z,      -r3x],
                  ...
                  [z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, I, z, z,    z,     z,   z,    z,       z,      z,      z,      z,      z,     z,      -r4z,   r4y],
                  [z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, I, z,    z,     z,   z,    z,       z,      z,      z,      z,      z,     r4z,    z,      -r4x],
                  [z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, z, I,    z,     z,   z,    z,       z,      z,      z,      z,      z,     -r4y,   r4x,    z],

                  [k, z, z, z, -r1z, r1y,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, k, z, r1z, z, -r1x,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, k, -r1y, r1x, z,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],

                  [k, z, z, z, r1z, -r1y,   o, z, z, z, r2z, -r2y,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, k, z, -r1z, z, r1x,   z, o, z, -r2z, z, r2x,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, k, r1y, -r1x, z,   z, z, o, r2y, -r2x, z,   z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  
                  [z, z, z, z, z, z,   k, z, z, z, r2z, -r2y,   o, z, z, z, r3z, -r3y,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, z, z, z, z,   z, k, z, -r2z, z, r2x,   z, o, z, -r3z, z, r3x,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, z, z, z, z,   z, z, k, r2y, -r2x, z,   z, z, o, r3y, -r3x, z,   z, z, z, z, z, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  
                  [z, z, z, z, z, z,   z, z, z, z, z, z,   k, z, z, z, r3z, -r3y,   o, z, z, z, r4z, -r4y,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, z, z, z, z,   z, z, z, z, z, z,   z, k, z, -r3z, z, r3x,   z, o, z, -r4z, z, r4x,   z, z, z,  z, z, z,  z, z, z,  z, z, z],
                  [z, z, z, z, z, z,   z, z, z, z, z, z,   z, z, k, r3y, -r3x, z,   z, z, o, r4y, -r4x, z,   z, z, z,  z, z, z,  z, z, z,  z, z, z]
                  ])
    
    b = np.array([z, -10.0, z, -k_d*w1[0], -k_d*w1[1], -k_d*w1[2],   z, -10.0, z, -k_d*w2[0], -k_d*w2[1], -k_d*w2[2],   z, -10.0, z, -k_d*w3[0], -k_d*w3[1], -k_d*w3[2],   z, -10.0, z, -k_d*w4[0], -k_d*w4[1], -k_d*w4[2],   w1w1r1[0], w1w1r1[1], w1w1r1[2],   w1w1r1[0]-w2w2r2[0], w1w1r1[1]-w2w2r2[1], w1w1r1[2]-w2w2r2[2],   w2w2r2[0]-w3w3r3[0], w2w2r2[1]-w3w3r3[1], w2w2r2[2]-w3w3r3[2],   w3w3r3[0]-w4w4r4[0], w3w3r3[1]-w4w4r4[1], w3w3r3[2]-w4w4r4[2]])
    ...
    omega_dot4 = np.array([x[21], x[22], x[23]])
    # print(acc1)

    # Constraint things
    cpoint1 = link1.posn + r1
    cvelocity1 = (link1.vel + np.cross(link1.omega, r1))
    factor1 = 100*(cpoint1 - init_cpoint1) + 100*(cvelocity1)
    acc1 -= factor1

    cpoint2 = link2.posn + r2
    cdiff2 = cpoint2 - (link1.posn - r1)
    cvelocity2 = (link2.vel + np.cross(link2.omega, r2)) - (link1.vel + np.cross(link1.omega, -r1))
    factor2 = 100*(cdiff2) + 100*(cvelocity2)
    acc2 = acc2 - factor2 + acc1

    cpoint3 = link3.posn + r3
    cdiff3 = cpoint3 - (link2.posn - r2)
    cvelocity3 = (link3.vel + np.cross(link3.omega, r3)) - (link2.vel + np.cross(link2.omega, -r2))
    factor3 = 100*(cdiff3) + 100*(cvelocity3)
    acc3 = acc3 - factor3 + acc2

    cpoint4 = link4.posn + r4
    cdiff4 = cpoint4 - (link3.posn - r3)
    cvelocity4 = (link4.vel + np.cross(link4.omega, r4)) - (link3.vel + np.cross(link3.omega, -r3))
...
def rotate_twice(vector, thetaz, thetax):
    ...
    return np.matmul(rotx, np.matmul(rotz, vector))
